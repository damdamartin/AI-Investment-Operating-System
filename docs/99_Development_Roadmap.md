...
- the final Toss read-only call gate passes before any real read-only API attempt
- Phase 5 completion command reports readiness before the first real read-only call
